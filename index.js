...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Alexandro Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6285263628789:+62 852-6362-8789\n' 
            + 'END:VCARD' 
prefix = '#'
blocked = []          
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('qr already scan.subscribe','white'),color('YOU','red'),color('TUBE','white'),color('Alexandro Sihotang','yellow'))
})
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6285263628789@s.whatsapp.net"] 
          ...
          case 'ping':
            ...
            break
				case 'info':
					...
					teks = `*Nama bot* : ${me.name}\n*OWNER* : *Alexandro Sihotang*\n*AUTHOR* : Alexandro Sihotang x Affis\n*Nomor Bot* : @${me.jid.split('@')[0]}\n*Prefix* : ${prefix}\n*Total Block Contact* : ${blocked.length}\n*The bot is active on* : ${kyun(uptime)}`
                ...
                case 'truth':
					...
					break
				case 'dare':
					const dare =['Kirim pesan ke mantan kamu dan bilang "aku masih suka sama kamu','telfon crush/pacar sekarang dan ss ke pemain','pap ke salah satu anggota grup','Bilang "KAMU CANTIK BANGET NGGAK BOHONG" ke cowo','ss recent call whatsapp','drop emot "🦄💨" setiap ngetik di gc/pc selama 1 hari','kirim voice note bilang can i call u baby?','drop kutipan lagu/quote, terus tag member yang cocok buat kutipan itu','pake foto sule sampe 3 hari','ketik pake bahasa daerah 24 jam','ganti nama menjadi "gue anak lucinta luna" selama 5 jam','chat ke kontak wa urutan sesuai %batre kamu, terus bilang ke dia "i lucky to hv you','prank chat mantan dan bilang " i love u, pgn balikan','record voice sambil nyanyi','bilang "i hv crush on you, mau jadi pacarku gak?" ke lawan jenis yang terakhir bgt kamu chat (serah di wa/tele), tunggu dia bales, kalo udah ss drop ke sini','sebutkan tipe pacar mu!','snap/post foto pacar/crush','teriak gajelas lalu kirim pake vn kesini','pap mukamu lalu kirim ke salah satu temanmu','kirim fotomu dengan caption, aku anak pungut','teriak pake kata kasar sambil vn trus kirim kesini','teriak " anjimm gabutt anjimmm " di depan rumah mu','ganti nama jadi " BOWO " selama 24 jam','Pura pura kerasukan, contoh : kerasukan maung, kerasukan belalang, kerasukan kulkas, dll']
                ...
                case 'bug':
                    ...
                    client.sendMessage('6285263628789@s.whatsapp.net', options, text, {quoted: mek})
            ...
            break	
               ...
               if (!isGroup) return reply(mess.only.group)
                ...
                case 'r':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Selamat @${mentioned[0].split('@')[0]} 👌(+_+)`, mentioned, true)
						client.groupMakeAdmin(from, mentioned)
					}
					break	
				case 'r2':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Kasihan @${mentioned[0].split('@')[0]} 😀`, mentioned, true)
						client.groupDemoteAdmin(from, mentioned)
					}
					break
                case 'r3':
               ...
               case 'r4':
                ...
                case 'r5':
					...
					if (!isOwner) return reply(mess.only.ownerB)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('Yang mau di add siapa goblok?😊')
					...
					try {
						...
						console.log('Error :', e)
						reply('Gagal mungkin di private')
					}
					break
                case 'r6':
					if (!isGroup) return reply(mess.only.group)
					...
					if (mentioned.length > 1) {
						...
						mentions(`MAMPUS @${mentioned[0].split('@')[0]} 😆`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
                   case 'r7': 
           ...
           case 'r8':
                ...
                client.sendMessage(from, 'Sudah bro', text, {quoted: mek})
                break
                case 'r9':
                if (!isGroup) return reply(mess.only.group)
			    if (!isOwner) return reply(mess.only.ownerB)
               ...
               case 'r10':
					...
					if (Number(args[0]) === 1) {
						...
						reply('Sudah hidup bro')
					} else if (Number(args[0]) === 0) {
						welkom.splice(from, 1)
						fs.writeFileSync('./src/welkom.json', JSON.stringify(welkom))
						reply('Sudah mati bro')
					} else {
						reply(' *Ketik perintah 1 untuk mengaktifkan, 0 untuk menonaktifkan* \n *Contoh: ${prefix}r10 1*')
					}
					break	
            ...
            case 'owner':
            case 'creator':
                  client.sendMessage(from, {displayname: "Alexandro", vcard: vcard}, MessageType.contact, { quoted: mek})
           ...
           case 'demote':
				...
				case 'toimg':
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: '𝗱𝗮𝗵𝗵 𝗷𝗮𝗱𝗶 '})
						fs.unlinkSync(ran)
					})
					break
                 case 'simi':
